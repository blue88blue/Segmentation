...
import csv
import shutil
from dataset.dataset_PMdata620 import *
...
class basic_setting():
    ...
    # #################################### train Data settings ####################################
    dataset_file_list = "utils/PMdata620_dataset_list.csv"  # 交叉验证所需文件名列表
    data_root = '/home/sjh/dataset/PLAM/data620/crop_512/image'
    target_root = "/home/sjh/dataset/PLAM/data620/crop_512/mask"  # 萎缩标签
    crop_size = (512, 512)
