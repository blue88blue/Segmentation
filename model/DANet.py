...
class DANet(SegBaseModel):
    ...
    def __init__(self, n_class, backbone='resnet34', aux=False, pretrained_base=False, dilated=False, **kwargs):
        super(DANet, self).__init__(backbone, pretrained_base=pretrained_base, dilated=dilated, **kwargs)
        self.aux = aux
        self.head = _DAHead(self.base_channel[-1], n_class, aux, **kwargs)
