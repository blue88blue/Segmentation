...
class EMUnet(nn.Module):
    def __init__(self, in_channel, n_class, channel_reduction=2, aux=False):
        ...
        self.donv_up1 = EMA_UP_docoder(channels[3], channels[3])
        self.donv_up2 = EMA_UP_docoder(channels[3], channels[2])
        self.donv_up3 = EMA_UP_docoder(channels[2], channels[1])
        self.donv_up4 = EMA_UP_docoder(channels[1], channels[0])
    ...
    def forward(self, x):
        ...
        x, mu1 = self.donv_up1(x_mid, x4)
        x, mu2 = self.donv_up2(x, x3)
        x, mu3 = self.donv_up3(x, x2)
        x, mu4 = self.donv_up4(x, x1)
