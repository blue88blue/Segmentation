...
class CPFNet(SegBaseModel):
    def __init__(self, n_class=1, backbone="resnet34", aux=False, pretrained_base=False, dilated=False, base_channel=32, **kwargs):
        super(CPFNet, self).__init__(backbone, pretrained_base=pretrained_base, dilated=dilated, **kwargs)
        self.aux = aux
...
if __name__ == "__main__":
    ...
    model = CPFNet(1, "resnet34", aux=False, pretrained_base=False, dilated=False)
    out = model(img)
    print(out[0].size())